  ...
  <div>
      ...
      <div className="addContainer">
       ...
       <img src={resObj.img} alt="File--upload" style={{width:"100px",height:"100px"}}/>
          ...
          <span >Name of the dish:   </span><input style={{fontSize:"16px",padding:"7px"}} onChange={handleChange} type="text" name='receiptName'/>
          </div>
           <div className="recDesc">
           <span>Short description:  </span><textarea className='textarea' onChange={handleChange} type="text" name='desc'/>
           </div>
         <div className="recImg">
         </div>
          <div className="recTime">
          <span>Time to cook (in minutes):  </span><input style={{fontSize:"16px",padding:"7px"}} onChange={handleChange}type="number" name='time'/>
          </div>
         <div className="select">
           <span>Select category:  </span>
            <select style={{fontSize:"16px",padding:"7px"}}  onChange={handleChange} name="selectRec">
          ...
          <div style={{display:"flex",justifyContent:"space-around"}} className="span">
           ...
           <p style={{textAlign:"center",fontSize:"16px"}}>(indicating the unit of measurement)</p>
                ...
                <input style={{fontSize:"16px",padding:"7px"}} onChange={handleChange}  name={item.ingrName} type="text" />
                </div>
             <div className="ingredQuant">
             <input style={{fontSize:"16px",padding:"7px"}} name={item.ingrQuant} onChange={handleChange} type="text" />
             </div>
              </div>
                    </>
                  ))
                }         
              <button style={{backgroundColor:"#F4A900",fontSize:"16px",cursor:"pointer",padding:"10px"}}>Send</button>      
           </div>
          </form>
         </div>
        </div>
